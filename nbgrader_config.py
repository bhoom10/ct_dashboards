...
#  `directory_structure` config option.
#  Default: 'source'
c.CourseDirectory.source_directory = 'python-basic-programming-master'
...
## 
#  See also: ExecutePreprocessor.force_raise_errors
# c.Execute.force_raise_errors = False

## 
#  See also: ExecutePreprocessor.iopub_timeout
# c.Execute.iopub_timeout = 4

## Path to file to use for SQLite history database for an IPython kernel.
#  See also: ExecutePreprocessor.ipython_hist_file
# c.Execute.ipython_hist_file = ':memory:'

## The kernel manager class to use.
#  See also: ExecutePreprocessor.kernel_manager_class
# c.Execute.kernel_manager_class = 'builtins.object'

## 
#  See also: ExecutePreprocessor.kernel_name
# c.Execute.kernel_name = ''

## 
#  See also: ExecutePreprocessor.shutdown_kernel
# c.Execute.shutdown_kernel = 'graceful'

## 
#  See also: ExecutePreprocessor.startup_timeout
# c.Execute.startup_timeout = 60

## 
#  See also: ExecutePreprocessor.store_widget_state
# c.Execute.store_widget_state = True

## 
#  See also: ExecutePreprocessor.timeout
# c.Execute.timeout = 30

## 
#  See also: ExecutePreprocessor.timeout_func
